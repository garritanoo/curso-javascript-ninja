...
*/
function showErroMessage(operator) {
...
if (sum) {
	...
	console.log(showErroMessage(operationSignal));
}
...
operationSignal = '/';
var divison = calculator(operationSignal);
if (divison) {
	number1 = 20;
	number2 = 5;
	console.log(showOperationMessage( operationSignal, number1, number2 ), divison( number1, number2 ));
} else {
	console.log(showErroMessage(operationSignal));
}
